    ...
    return (
      <div className="theme-page">
        ...
        <div className="container">
          <div className="row container">
            <div className="col-12 col-md-6 opaque ">
              <br />
              concetto - the 3 day annual techno-management fest of IIT(ISM)
              Dhanbad. concetto is the place where the magnificent minds of
              ...
              make learning fun. concetto is here with the events like “Sky is
              the limit’’, “Runism”, “Tradathon”, “Bussinelytics” and many more
              which also includes cultural events,workshops,guest lectures.
              <br /> <br />
              The theme of concetto’22 is “AUGMENTED REALITY - VIRTUAL
        ...
        <div className="container opaque">
          ...
          explore and interact with.This theme of concetto ’22 serves as a
          reminder that imagination is our only limit, and that technology holds
          the key to shaping our future.concetto ’22 has informative workshops,
          ...
          more!concetto ’22 returns, bigger and bolder than ever before, and is
          ...
          presenting <b>concetto: REALITY BEYOND VISION</b>.
        </div>
        <br />
        <h1
          style={{
        ...
        <div className="container opaque">
          ...
          fest, "concetto 22", starting on 21st October 2022. The three-day fest
          ...
          <br />
          <br />
          To bridge the digital and physical worlds, this year's concetto is
          ...
          challenges and adding a new dimension to concetto
          <br />
          <br />
